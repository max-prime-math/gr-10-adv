...
\end{align*}
\clearpage
\prb{The formula for the slope-point form of a line is:}
\sol{$y=m(x-x_0)+y_0$; $m$ is the slope, $(x_0,y_0)$ is any point on the line.}
\vfill
\prb{The formula for slope-intercept form of a line is: }
\sol{$y=mx+b$; $m$ is the slope, $(0,b)$ is the $y$-intercept.}
\vfill 
\prb{The slope of the line $Ax+By=C$ is:}
\sol{$m=-\frac AB$.}
\vfill
...
\prb{Graph each linear equation.
    ...
    \vfill
    \begin{tasks}(2)
        \task[g)] $\ds y-\frac 52 = -\frac 12 \left(x+\frac 32\right)$\\
		\blankgraph{-10}{10}{-10}{10}{3}{3}
        \task[h)] $\ds y=\frac 53x - \frac 72$\\
		\blankgraph{-10}{10}{-10}{10}{3}{3}
	\end{tasks}
    \vfill
}
...
\clearpage
\chapter{3. Linear Relations in 3D.}
...
\begin{figure}[h]
	\begin{minipage}{.5\textwidth}
        ...
        \qrcode[height=2in]{https://play.google.com/store/apps/details?id=org.geogebra.android.g3d}
	\end{minipage}%
	\begin{minipage}{.5\textwidth}
		\centering
		\caption*{Geogebra 3D for iOS}
        \qrcode[height=2in]{https://apps.apple.com/us/app/geogebra-3d-calculator/id1445871976}
	\end{minipage}
\end{figure}
\clearpage
...
\vfill
\clearpage
\prb{Find a solution to the equation $-x+2y-8z=0$.}
...
\vfill
\prb{Describe the necessary and sufficient conditions for three planes to intersect at infinitely many points.}
...
\clearpage
\prb{
	Describe the necessary and sufficient conditions for three planes to intersect, but not all three at the same place.  (In other words, there is no point that is on all three planes at the same time, but any two of the three do in fact intersect.)
}
...
\sol{Necessary: None of the planes can be parallel to any other plane. \\
    ...
    \vfill 
\prb{
	What are the $x$-, $y$-, and $z$- intercepts of the equation $-4x+3y-6z=12$?
}
\sol{$x=-3$, $y=4$, $z=-2$.}
\vfill
...
\vfill
\chapter{4. Solving Systems With Three Variables.}
