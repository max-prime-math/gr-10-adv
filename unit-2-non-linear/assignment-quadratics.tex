...
\\[4in]
\end{tasks}
Hint: Use a stretch factor of $-5$ for this parabola.  The correct stretch factor is closer to $-4.9$, which is half of Earth’s gravity measured in metres per second squared.  We're going to use $-5$ to make our algebra nicer. Ask your physics teacher why it's 4.9!
\end{document}
