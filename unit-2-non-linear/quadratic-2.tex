...
\[
	...
	\end{tikzpicture}
\]
As you can see, the parabola does not have any points that have $y$-coordinates less than $-4$.  That's because it points upwards, and the vertex is at the point $(1,-4)$.
...
\\
  \includegraphics[height=2in]{figures/circle-in-circle.png}
}
