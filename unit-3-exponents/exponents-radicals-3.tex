...
\prb{
    ...
    \begin{tasks}(3)
        ...
        \task $f(x)=\frac{1}{x+2}$
        \\[2in]
        \task $\displaystyle f(x)=\frac{x-2}{x+2}$
        \\[2in]
        \task $\displaystyle f(x)=\frac{x}{x+4}$
        \\[2in]
        \task $\displaystyle f(x)=\frac{3 x}{x-2}$
        \\[2in]
        \task $\displaystyle f(x)=\frac{2 x+5}{x-7}$
        \\[2in]
        \task $\displaystyle f(x)=\frac{4 x-2}{3 x+1}$
        \\[2in]
        \task $\displaystyle f(x)=\frac{2 x+3}{1-5 x}$
        \\[2in]
        \task $\displaystyle f(x)=\frac{3-4 x}{8 x-1}$
        \\[2in]
...
\sol{
    \begin{tasks}(3)
\task[a)] $f^{-1}(x)=\frac{1}{3} x-\frac{5}{3}$
\task[c)] $f^{-1}(x)=\sqrt[3]{\frac{1}{4}(5-x)}$
\task[e)] $f^{-1}(x)=\frac{1}{x}-2$
\task[g)] $f^{-1}(x)=\frac{4 x}{1-x}$
\task[i)] $f^{-1}(x)=\frac{7 x+5}{x-2}$
\task[k)] $f^{-1}(x)=\frac{x-3}{5 x+2}$
\task[m)] $f^{-1}(x)=\sqrt{4-x}, x \leq 4$
\task[o)] $f^{-1}(x)=\sqrt[6]{x}, x \geqslant 0$
\task[q)] $f^{-1}(x)=\sqrt[3]{2-5 x}$
\task[s)] $f^{-1}(x)=\frac{x^2-5}{8}, x \geq 0$
\task[t)] $f^{-1}(x)=(x-2)^3$
\end{tasks}
}
\chapter{3. The Radical Function}
The last section was a short detour to wind up talking about the radical function.  In order to fully understand the radical function, we must be familiar with the following ideas:
\begin{itemize}
    \item domain
    \item range
    \item one-to-one
...
\]
\clearpage
\prb{Graph the radical function $y=\sqrt x$ and use it to approximate $\sqrt 2$, $\sqrt 3$, $\ldots$, and $\sqrt {15}$.
    \\[1em]
\blankgraph{0}{16}{0}{4}{8}{2}
}
\sol{Use a calculator to verify your answers.}
...
\sol{See the proof that the square root of 2 is irrational, and compare to that.}
...
\task $\frac{9}{x^8}$
\task $\frac{8}{a^{12}}$
\task $\frac{81 x^{16}}{y^8}$
\task $\frac{16}{a^6 b^4}$
\task $-\frac{y^3}{512 x^6}$
\end{tasks}
...
\task $3 x^8$
\task $\frac{1}{27 x^9}$
\task $\frac{8 a^6}{b^{12} c^{15}}$
\task $\frac{27 b^{12}}{8 a^6}$
\end{tasks}
}
\prb{
    Simplify. Express without brackets or negative exponents.\\
...
\sol{
    \begin{tasks}(4)
\task $\frac{16 a^{11}}{b^5}$
\task $\frac{1}{x^3 y^8}$
\task $\frac{400}{m^5 n^3}$
\task $81 a^3 b^4$
\task $\frac{3 x^2}{400 y^3}$
\task $\frac{a^{14} b^4}{16}$
\task $\frac{x^{24}}{64 y^{16}}$
\task $\frac{8 b^{15}}{3 a^{18}}$
\task $\frac{y^6}{96 x^7}$
\task $\frac{15625 y^{18}}{4 x^{12}}$
    \end{tasks}
}
\clearpage
